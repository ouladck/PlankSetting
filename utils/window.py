...
class Window:
	def __init__(self, setting_path):
		...
		self.label4.set_tooltip_text(g("Time (in ms) to wait before unhiding the dock."))
		...
		self.label6.set_tooltip_text(g("The position for the dock on the monitor."))
		...
		self.label7.set_tooltip_text(g("The dock's position offset from center (in percent)."))
		...
		self.label8.set_tooltip_text(g("The alignment for the dock on the monitor's edge."))
		...
		self.label9.set_tooltip_text(g("The alignment of the items in this dock."))
		...
		self.label10.set_tooltip_text(g("Prevent drag'n'drop actions and lock items on the dock."))

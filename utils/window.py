...
class Window:
	def __init__(self, setting_path):
		...
		self.label1 = Gtk.Label(g("Show only windows of the current workspace."))
		self.switch = Gtk.Switch()
		self.switch.connect("notify::active", self.switched)
		
		#The size of dock icons (in pixels).
		self.label2 = Gtk.Label(g("The size of dock icons (in pixels)."))
		...
		self.label3 = Gtk.Label(g("The display of the dock."))
		self.display = self.radios(g("Don't hide"), g("Intelligently hide"), g("Auto hide"), g("Dodge"), 1)
		
		#Time (in ms) to wait before unhiding the dock.
		self.label4 = Gtk.Label(g("Time (in ms) to wait before unhiding the dock."))
		...
		self.label6 = Gtk.Label(g("The position for the dock on the monitor."))
		self.pos = self.radios(g("Left"), g("Right"), g("Top"), g("Bottom"), 2)
		
		#The dock's position offset from center (in percent).
		self.label7 = Gtk.Label(g("The dock's position offset from center (in percent)."))
		...
		self.label8 = Gtk.Label(g("The alignment for the dock on the monitor's edge."))
		self.alignment = self.radios(g("Panel mode"), g("Right aligned"), g("Left aligned"), g("Centered"), 3)
		
		#The alignment of the items in this dock if panel-mode is used.  If 1, right-aligned.  If 2, left-aligned.  If 3, centered.
		self.label9 = Gtk.Label(g("The alignment of the items in this dock."))
		self.itemalig = self.radios(g("Panel mode"), g("Right aligned"), g("Left aligned"), g("Centered"), 4)
		
		#Whether to prevent drag'n'drop actions and lock items on the dock.
		self.label10 = Gtk.Label(g("Prevent drag'n'drop actions and lock items on the dock."))
